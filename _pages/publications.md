...
{% if site.author.googlescholar %}
  ...
  <strong>You can also find my articles on</strong> <a class='colorchangeonly' href="{{site.author.googlescholar}}" target="_blank"><strong>my Google Scholar profile</strong></a>.
{% endif %}
